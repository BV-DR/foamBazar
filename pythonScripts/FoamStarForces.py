...
if __name__ == "__main__" :
   ...
   """
      ...
      FoamStarForces forces.dat -indexName Fx Fy         #->plot the selected componets, based on labels
      FoamStarForces forces.dat -index     0  1          #->plot the selected componets, based on indexes
